...
public class Dataset {
    ...
    private Map<Long, Diagnostico> historiasClinicas;
    
    private ArrayList<String> enfermedadesHC;
    private ArrayList<String> conjEnfermedades;   // Atributo para el conjunto de enfermedades sin repetir
    
    private ArrayList<String> sintomasHC;
    private ArrayList<String> conjSintomas;   // Atributo para el conjunto de síntomas sin repetir
